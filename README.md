...
Clone the repository and run <code>npm install</code> and <code>npm exec allow-scripts setup</code> and <code>npm run dev</code> to start the development server.
