...
const CareerPlanning = () => {
  ...
  return (
    <div>
      <BackButton />
      <h1 className="mt-5 mb-5 text-heading-2 sm:mt-7 sm:text-heading-1">{t('career-management.title')}</h1>
      ...
      <h2 className="mb-3 text-heading-3 sm:text-heading-2">{t('career-management.self-evaluation.title')}</h2>
